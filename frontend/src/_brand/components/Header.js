                ...
                <Container>
                    <Navbar.Brand href="/">
                        <div className="logoHeader">
                            ...
                            <span style={{ fontSize: "16px", paddingLeft: "10px" }}>Brand</span>
                        </div>
                    </Navbar.Brand>
                    <Navbar.Toggle aria-controls="responsive-navbar-nav" />
                    <Navbar.Collapse className="justify-content-end" id="responsive-navbar-nav">
                        <Nav>
                            <Nav.Link href="/_brand/">
                                <span className="navButtons">Dashboard</span>
                            </Nav.Link>

                            <Nav.Link href="/_brand/deals">
                                <span className="navButtons">Deals</span>
                            </Nav.Link>
                            <Nav.Link href="/_brand/jobs">
                                <span className="navButtons">Jobs</span>
                            </Nav.Link>
                            <Nav.Link href="/_brand/profile">
